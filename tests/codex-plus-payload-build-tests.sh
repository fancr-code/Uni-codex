...
SOURCE_FIXTURE="$TEST_ROOT/CodexPlusPlus-1.2.44"
...
(
  cd "$TEST_ROOT"
  tar -czf CodexPlusPlus-v1.2.44.tar.gz CodexPlusPlus-1.2.44
)
  ...
  "files": [
    {
      ...
      "version": "1.2.44",
      "architecture": "arm64",
      "relativePath": "apps/CodexPlusPlus-1.2.44-macos-arm64.dmg",
    ...
    },
    {
      ...
      "version": "1.2.44",
      "architecture": "x86_64",
      "relativePath": "apps/CodexPlusPlus-1.2.44-macos-x64.dmg",
    ...
    },
    {
      ...
      "version": "1.2.44",
      "architecture": "source",
      "relativePath": "sources/CodexPlusPlus-v1.2.44.tar.gz",
...
TEST_MODE=1 \
SOURCE_ARCHIVE="$TEST_ROOT/CodexPlusPlus-v1.2.44.tar.gz" \
...
arm_dmg="$OUTPUT_ROOT/apps/CodexPlusPlus-1.2.44-codexkit.1-macos-arm64.dmg"
x64_dmg="$OUTPUT_ROOT/apps/CodexPlusPlus-1.2.44-codexkit.1-macos-x64.dmg"
source_archive="$OUTPUT_ROOT/sources/CodexPlusPlus-v1.2.44-codexkit.1.tar.gz"
...
provenance_file="$source_extract/CodexPlusPlus-1.2.44/CODEXKIT-PATCH.md"
expected_patch_sha="$(shasum -a 256 "$ROOT/patches/CodexPlusPlus/v1.2.44-cross-provider-history.patch" | awk '{print $1}')"
...
rg -F 'source archive must contain CodexPlusPlus-1.2.44' "$TEST_ROOT/wrong-version.log" >/dev/null \
